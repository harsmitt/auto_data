...
# #
# # #
# # class NewBalanceSheetAdmin(admin.ModelAdmin):
...
#     # def button(self, obj):
#     #
#     #     x = quarter_data.objects.filter(gbc_name=obj.gbc_name, section=obj.section, subsection=obj.subsection,
#     #                                  s2section=obj.s2section,page_extraction='bsheet').order_by('subsection_id')
#     #     if x :
