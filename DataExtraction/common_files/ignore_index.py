    ...
    try:
        ...
        if notes and \
            ...
            return kwargs['ignore_index']
                ...
                if len(re.split('  +',kwargs['line']))>1 and  notes[0] in re.split('  +',kwargs['line']):
                    n_index = re.split('  +', kwargs['line']).index(notes[0]) if notes[0] in re.split('  +', kwargs['line']) else None
